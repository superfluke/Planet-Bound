...
{
    private final WorldGenMinable rendiumGenerator = new WorldGenMinable(PBBlocks.rendium_ore.getDefaultState(), 7); //Same as lapis
    private final WorldGenMinable verdaniteGenerator = new WorldGenMinable(PBBlocks.verdanite_ore.getDefaultState(), 9); //Same as iron
    private final WorldGenMinable kybriteGenerator = new WorldGenMinable(PBBlocks.kybrite_ore.getDefaultState(), 9); //Same as iron
