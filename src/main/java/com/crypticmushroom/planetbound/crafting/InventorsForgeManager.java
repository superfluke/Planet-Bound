...
public class InventorsForgeManager
{
    ...
    {
        registerRecipe(new ItemStack[]{new ItemStack(PBBlocks.verdanite_ore), new ItemStack(PBBlocks.kybrite_ore)}, new ItemStack(PBItems.fortium_ingot, 1), 0.7F);
    ...
    public static void registerRecipe(ItemStack[] input, ItemStack output, float xp)
    {
        ...
        // hacking into furnace xp values is much easier than creating my own output
        // slots
